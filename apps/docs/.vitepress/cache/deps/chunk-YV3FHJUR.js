...
function cumsum(values, valueof) {
  ...
  return Float64Array.from(
    ...
    valueof === void 0
      ? (v) => (sum2 += +v || 0)
      : (v) => (sum2 += +valueof(v, index2++, values) || 0),
  );
}
...
function fcumsum(values, valueof) {
  ...
  return Float64Array.from(
    ...
    valueof === void 0
      ? (v) => adder.add(+v || 0)
      : (v) => adder.add(+valueof(v, ++index2, values) || 0),
  );
}
...
function ticks(start, stop, count2) {
  ...
  const reverse2 = stop < start,
    [i1, i2, inc] = reverse2 ? tickSpec(stop, start, count2) : tickSpec(start, stop, count2);
  if (!(i2 >= i1)) return [];
  const n = i2 - i1 + 1,
    ticks2 = new Array(n);
  if (reverse2) {
...
function tickStep(start, stop, count2) {
  ((stop = +stop), (start = +start), (count2 = +count2));
  const reverse2 = stop < start,
    inc = reverse2 ? tickIncrement(stop, start, count2) : tickIncrement(start, stop, count2);
...
function bin() {
  ...
  histogram.thresholds = function (_) {
    return arguments.length
      ? ((threshold = typeof _ === 'function' ? _ : constant(Array.isArray(_) ? slice.call(_) : _)),
        histogram)
      : threshold;
  };
  return histogram;
  ...
  if (valueof === void 0) {
    ...
    for (let value of values) {
      if (
        ...
        (max2 < value || (max2 === void 0 && value >= value))
      ) {
        max2 = value;
      }
    }
...
function min(values, valueof) {
  ...
  if (valueof === void 0) {
    ...
    for (let value of values) {
      if (
        (value = valueof(value, ++index2, values)) != null &&
        (min2 > value || (min2 === void 0 && value >= value))
      ) {
        min2 = value;
      }
    }
...
function quantileIndex(values, p, valueof = number) {
  ...
  var numbers2,
    index2 = Uint32Array.from(values, (_, i2) => i2),
    j = numbers2.length - 1,
    i = Math.floor(j * p);
...
//# sourceMappingURL=chunk-YV3FHJUR.js.map
