...
var Path = class {
  ...
  arc(x2, y2, r, a0, a1, ccw) {
    ...
    if (da > tauEpsilon) {
      ...
      this
        ._append`A${r},${r},0,${+(da >= pi2)},${cw},${(this._x1 = x2 + r * Math.cos(a1))},${(this._y1 = y2 + r * Math.sin(a1))}`;
    }
  }
  rect(x2, y2, w, h) {
    this
...
function arc_default() {
  var innerRadius = arcInnerRadius,
    ...
    cornerRadius = constant_default(0),
    padRadius = null,
  ...
  function arc() {
    ...
    if (!(r1 > epsilon)) context.moveTo(0, 0);
      ...
      var a01 = a0,
        ...
        rp =
          ap > epsilon && (padRadius ? +padRadius.apply(this, arguments) : sqrt(r0 * r0 + r1 * r1)),
          ...
          if ((oc = intersect(x01, y01, x00, y00, x11, y11, x10, y10))) {
            var ax = x01 - oc[0],
              ...
              kc =
                1 /
                sin(
                  acos((ax * bx + ay * by) / (sqrt(ax * ax + ay * ay) * sqrt(bx * bx + by * by))) /
                    2,
                ),
  ...
  arc.innerRadius = function (_) {
    return arguments.length
      ? ((innerRadius = typeof _ === 'function' ? _ : constant_default(+_)), arc)
      : innerRadius;
  };
  arc.outerRadius = function (_) {
    return arguments.length
      ? ((outerRadius = typeof _ === 'function' ? _ : constant_default(+_)), arc)
      : outerRadius;
  };
  arc.cornerRadius = function (_) {
    return arguments.length
      ? ((cornerRadius = typeof _ === 'function' ? _ : constant_default(+_)), arc)
      : cornerRadius;
  };
  arc.padRadius = function (_) {
    return arguments.length
      ? ((padRadius = _ == null ? null : typeof _ === 'function' ? _ : constant_default(+_)), arc)
      : padRadius;
  };
  arc.startAngle = function (_) {
    return arguments.length
      ? ((startAngle = typeof _ === 'function' ? _ : constant_default(+_)), arc)
      : startAngle;
  };
  arc.endAngle = function (_) {
    return arguments.length
      ? ((endAngle = typeof _ === 'function' ? _ : constant_default(+_)), arc)
      : endAngle;
  };
  arc.padAngle = function (_) {
    return arguments.length
      ? ((padAngle = typeof _ === 'function' ? _ : constant_default(+_)), arc)
      : padAngle;
  };
...
function pie_default() {
  var value = identity_default,
    ...
    sort = null,
    startAngle = constant_default(0),
    endAngle = constant_default(tau),
    padAngle = constant_default(0);
  function pie(data) {
    var i,
      n = (data = array_default(data)).length,
      j,
  ...
  pie.value = function (_) {
    return arguments.length
      ? ((value = typeof _ === 'function' ? _ : constant_default(+_)), pie)
      : value;
  };
  ...
  pie.startAngle = function (_) {
    return arguments.length
      ? ((startAngle = typeof _ === 'function' ? _ : constant_default(+_)), pie)
      : startAngle;
  };
  pie.endAngle = function (_) {
    return arguments.length
      ? ((endAngle = typeof _ === 'function' ? _ : constant_default(+_)), pie)
      : endAngle;
  };
  pie.padAngle = function (_) {
    return arguments.length
      ? ((padAngle = typeof _ === 'function' ? _ : constant_default(+_)), pie)
      : padAngle;
  };
  return pie;
}
...
function areaRadial_default() {
  var a2 = area_default().curve(curveRadialLinear),
    c2 = a2.curve,
    x0 = a2.lineX0,
    x1 = a2.lineX1,
    y0 = a2.lineY0,
...
function link(curve) {
  ...
  link2.x = function (_) {
    return arguments.length
      ? ((x2 = typeof _ === 'function' ? _ : constant_default(+_)), link2)
      : x2;
  };
  link2.y = function (_) {
    return arguments.length
      ? ((y2 = typeof _ === 'function' ? _ : constant_default(+_)), link2)
      : y2;
  };
  link2.context = function (_) {
    return arguments.length
      ? (_ == null ? (context = output = null) : (output = curve((context = _))), link2)
      : context;
  };
  return link2;
}
